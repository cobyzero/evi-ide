...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Evi warn -> off
			...
			// Evi - this should only apply to workbench/evi/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Evi
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Evi
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Evi
		}
	},
	// vscode TS
	{
