...
Evi separately records basic usage like the number of messages people are sending. If you'd like to disable Evi metrics, you may do so in Void's Settings.
`;
