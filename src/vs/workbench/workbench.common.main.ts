...
//#region --- Void
import './contrib/evi/browser/evi.contribution.js'; // Evi added this
//#endregion
...
// Chat
// Evi - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
