...
import { displayInfoOfProviderName, ProviderName, providerNames, isFeatureNameDisabled } from '../../../../common/voidSettingsTypes.js';
import { ChatMarkdownRender } from '../markdown/ChatMarkdownRender.js';
import { OneClickSwitchButton, SettingsForProvider } from '../void-settings-tsx/Settings.js';
...
const DeepSeekSetupPage = ({ pageIndex, setPageIndex }: { pageIndex: number, setPageIndex: (index: number) => void }) => {
	...
	return (
		<div className="flex flex-col items-center w-full max-w-[500px] mx-auto h-[80vh] gap-6">
			<div className="text-4xl font-light text-center mt-16">Connect DeepSeek</div>
			<div className="text-sm opacity-80 text-center text-void-fg-3">
...
const VoidOnboardingContent = () => {
	...
	const providerNamesOfWantToUseOption: { [wantToUseOption in WantToUseOption]: ProviderName[] } = {
		smart: ['deepseek', 'anthropic', 'openAI', 'gemini', 'openRouter'],
		private: ['ollama', 'vLLM', 'openAICompatible', 'lmStudio'],
		cheap: ['deepseek', 'gemini', 'openRouter', 'ollama', 'vLLM'],
		all: providerNames,
	}
		...
		0: <OnboardingPageShell
			content={
				<div className='flex flex-col items-center gap-8'>
					<div className="text-5xl font-light text-center">Welcome to Evi</div>
