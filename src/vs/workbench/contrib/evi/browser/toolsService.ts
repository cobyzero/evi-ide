...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IEviModelService voidModelService: IEviModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IEviCommandBarService private readonly commandBarService: IEviCommandBarService,
		...
		this.stringOfResult = {
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.eviSettingsService.state.globalSettings.includeToolLintErrors ?
			...
			run_command: (params, result) => {
				...
				if (resolveReason.type === 'timeout') {
					return `${result_}\nTerminal command ran, but was automatically killed by Evi after ${MAX_TERMINAL_INACTIVE_TIME}s of inactivity and did not finish successfully. To try with more time, open a persistent terminal and run the command there.`
				}
