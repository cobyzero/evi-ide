...
import { Diff, DiffArea, EviFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getEviFileSnapshot(uri: URI): EviFileSnapshot;
	restoreEviFileSnapshot(uri: URI, snapshot: EviFileSnapshot): void;
}
