...
class FilePromptActionService extends Action2 {
	private static readonly EVI_COPY_FILE_PROMPT_ID = 'evi.copyfileprompt'

	constructor() {
		super({
			id: FilePromptActionService.EVI_COPY_FILE_PROMPT_ID,
			title: localize2('eviCopyPrompt', 'Evi: Copy Prompt'),
			menu: [{
