...
class ConvertContribWorkbenchContribution extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.evi.convertcontrib'
	_serviceBrand: undefined;

	constructor(
		@IEviModelService private readonly voidModelService: IEviModelService,
		...
		const initializeURI = (uri: URI) => {
			...
			const voidRulesURI = URI.joinPath(uri, '.evirules')
