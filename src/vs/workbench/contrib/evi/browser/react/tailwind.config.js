	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--evi-fg-1)',
						'--tw-prose-headings': 'var(--evi-fg-1)',
						'--tw-prose-lead': 'var(--evi-fg-2)',
						'--tw-prose-links': 'var(--evi-link-color)',
						'--tw-prose-bold': 'var(--evi-fg-1)',
						'--tw-prose-counters': 'var(--evi-fg-3)',
						'--tw-prose-bullets': 'var(--evi-fg-3)',
						'--tw-prose-hr': 'var(--evi-border-4)',
						'--tw-prose-quotes': 'var(--evi-fg-1)',
						'--tw-prose-quote-borders': 'var(--evi-border-2)',
						'--tw-prose-captions': 'var(--evi-fg-3)',
						'--tw-prose-code': 'var(--evi-fg-0)',
						'--tw-prose-pre-code': 'var(--evi-fg-0)',
						'--tw-prose-pre-bg': 'var(--evi-bg-1)',
						'--tw-prose-th-borders': 'var(--evi-border-4)',
						'--tw-prose-td-borders': 'var(--evi-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'evi-bg-1': 'var(--evi-bg-1)',
				'evi-bg-1-alt': 'var(--evi-bg-1-alt)',
				'evi-bg-2': 'var(--evi-bg-2)',
				'evi-bg-2-alt': 'var(--evi-bg-2-alt)',
				'evi-bg-2-hover': 'var(--evi-bg-2-hover)',
				'evi-bg-3': 'var(--evi-bg-3)',


				'evi-fg-0': 'var(--evi-fg-0)',
				'evi-fg-1': 'var(--evi-fg-1)',
				'evi-fg-2': 'var(--evi-fg-2)',
				'evi-fg-3': 'var(--evi-fg-3)',
				// 'evi-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'evi-fg-4': 'var(--evi-fg-4)',

				'evi-warning': 'var(--evi-warning)',

				'evi-border-1': 'var(--evi-border-1)',
				'evi-border-2': 'var(--evi-border-2)',
				'evi-border-3': 'var(--evi-border-3)',
				'evi-border-4': 'var(--evi-border-4)',

				'evi-ring-color': 'var(--evi-ring-color)',
				'evi-link-color': 'var(--evi-link-color)',
