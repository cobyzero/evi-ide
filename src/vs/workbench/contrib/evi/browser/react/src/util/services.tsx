...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/evi/common/eviSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { EviSettingsState } from '../../../../../../../workbench/contrib/evi/common/eviSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/evi/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/evi/common/refreshModelService.js';
import { IEviSettingsService } from '../../../../../../../workbench/contrib/evi/common/eviSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/evi/browser/extensionTransferService.js'
...
let settingsState: EviSettingsState
const settingsStateListeners: Set<(s: EviSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IEviSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		voidCommandBarService: accessor.get(IEviCommandBarService),
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IEviSettingsService: accessor.get(IEviSettingsService),
		...
		IEviModelService: accessor.get(IEviModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IEviCommandBarService: accessor.get(IEviCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Evi useAccessor was called before _registerServices!`)
	}
