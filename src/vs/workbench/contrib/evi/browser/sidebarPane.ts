...
// const eviThemeIcon = Codicon.symbolObject;
// const eviViewIcon = registerIcon('evi-view-icon', eviThemeIcon, localize('eviViewIcon', 'View icon of the Evi chat view.'));

// called VIEWLET_ID in other places for some reason
export const EVI_VIEW_CONTAINER_ID = 'workbench.view.evi'
export const EVI_VIEW_ID = EVI_VIEW_CONTAINER_ID

// Register view container
const viewContainerRegistry = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry);
const container = viewContainerRegistry.registerViewContainer({
	id: EVI_VIEW_CONTAINER_ID,
	title: nls.localize2('eviContainer', 'Chat'), // this is used to say "Evi" (Ctrl + L)
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, [EVI_VIEW_CONTAINER_ID, {
...
// open sidebar
export const EVI_OPEN_SIDEBAR_ACTION_ID = 'evi.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: EVI_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open Evi Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	...
	constructor(
		...
		this.commandService.executeCommand(EVI_OPEN_SIDEBAR_ACTION_ID)
	}
}
