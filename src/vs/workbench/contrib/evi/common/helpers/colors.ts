...
// gets converted to --vscode-evi-greenBG, see void.css, asCssVariable
registerColor('evi.greenBG', configOfBG(acceptBG), '', true);
registerColor('evi.redBG', configOfBG(rejectBG), '', true);
registerColor('evi.sweepBG', configOfBG(sweepBG), '', true);
registerColor('evi.highlightBG', configOfBG(highlightBG), '', true);
registerColor('evi.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
