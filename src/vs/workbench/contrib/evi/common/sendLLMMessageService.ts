...
export class LLMMessageService extends Disposable implements ILLMMessageService {
	...
	constructor(
		...
		this.channel = this.mainProcessService.getChannel('evi-channel-llmMessage')
	...
	sendLLMMessage(params: ServiceSendLLMMessageParams) {
		...
		if (modelSelection === null) {
			const message = `Please add a provider in Evi Settings.`
		...
		const { settingsOfProvider, } = this.eviSettingsService.state
